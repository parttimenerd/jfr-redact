...
/**
 * Main CLI for JFR-Redact tool.
 *
 * This tool redacts sensitive information from Java Flight Recorder (JFR) recordings
 * while optionally preserving relationships through pseudonymization.
 */
@Command(
